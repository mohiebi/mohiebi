...
<table>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>CSV import with validation and duplicate detection — handles Persian digit normalization, Jalali calendar, and Rial→Toman conversion for local bank data.</p>
      <br/>
