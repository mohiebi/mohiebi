...
- Growing as a backend-focused full-stack developer at **MintMe**
- Building stronger NestJS and Laravel architectures
- Connecting backend systems with Vue-based frontends
- Learning deeper smart contract development with Solidity, Foundry, Forge, Cast, and Anvil
- Writing code that is easier to test, maintain, and extend
